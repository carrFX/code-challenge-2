    ...
    <section>
      <div className="px-7 py-12 my-11 rounded-lg flex lg:flex-row-reverse flex-col-reverse items-center justify-center">
        <div className="lg:w-1/2 my-2 lg:text-left text-center lg:border-l lg:border-l-[#b48e30] lg:pl-4 lg:ml-3">
          ...
          <p className="text-[#cbcbcb] mb-3">At Mansory Car Workshop, we believe that our culture is what sets us apart. We are committed to fostering a work environment that is both challenging and rewarding for our team members. Our core values include:</p>
          <ul>
